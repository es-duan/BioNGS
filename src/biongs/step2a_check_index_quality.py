...
This step analyzes the quality of demultiplexing results from Step 2 (step2_demultiplex_index.py).
...
Usage: python step2a_check_index_quality.py <experiment_name>
"""
