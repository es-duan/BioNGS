...
Description: This is the first step of the pipeline. The user provides an experiment name,
             and the step finds the multiplexing CSV file in the corresponding input_data
